app.controller('JurusansEditCtrl', ['$state', '$scope', 'jurusans', 'SweetAlert', 'toaster', '$stateParams', function ($state, $scope, jurusans, SweetAlert, toaster, mdToast, $stateParams) {
    $scope.id = $scope.$stateParams.id;
    //edit jurusans
    //If Id is empty, then redirected
    if ($scope.id == null || $scope.id == '') {
        $state.go("app.jurusans")
    }
