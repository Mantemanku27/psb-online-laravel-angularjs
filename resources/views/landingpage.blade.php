...
<body>
  ...
  <section id="Portfolio" class="content">
    ...
    <div class="portfolio">
      ...
      <div class="isotope" style="position: relative; overflow: hidden; height: 480px;" id="portfolio-wrap">
        ...
        <div class="portfolio-image"> <img src="../front/img/portfolio_pic1.jpg" alt="Portfolio 1"> </div>
        ...
        <!-- /end portfolio item with prettyphoto -->
        ...
        <div class="portfolio-image"> <img src="../front/img/portfolio_pic2.jpg" alt="Portfolio 1"> </div>
          <div class="project-overlay">
        ...
        <!-- /end portfolio item video expander  -->
        ...
        <div class="portfolio-image"> <img src="../front/img/portfolio_pic3.jpg" alt="Portfolio 1"> </div>
          <div class="project-overlay">
            <div class="open-project-link">
        ...
        <!-- /end portfolio item normal expander -->
        ...
        <div class="portfolio-image"> <img src="../front/img/portfolio_pic4.jpg" alt="Portfolio 1"> </div>
          <div class="project-overlay">
            <div class="open-project-link">
        ...
        <!-- /end portfolio item fullscreen expander -->
        ...
        <div class="portfolio-image"> <img src="../front/img/portfolio_pic5.jpg" alt="Portfolio 1"> </div>
          <div class="project-overlay">
            <div class="open-project-link">
        ...
        <div class="portfolio-image"> <img src="../front/img/portfolio_pic6.jpg" alt="Portfolio 1"> </div>
          <div class="project-overlay">
            <div class="open-project-link">
        ...
        <div class="portfolio-image"> <img src="../front/img/portfolio_pic7.jpg" alt="Portfolio 1"> </div>
        ...
        <!-- /end portfolio item external project  -->
        ...
        <div class="portfolio-image"> <img src="../front/img/portfolio_pic8.jpg" alt="Portfolio 1"> </div>
  ...
  <section class="twitter-feed">
    ...
    <div class="container  animated fadeInDown delay-07s wow">
      ...
      <p> When you're the underdog, your only option is to make #waves if you want to succeed. How much <br> and how often should
        you be drinking coffee?</p>
        ...
        <div class="row">
          <div class="col-lg-6 wow fadeInLeft">
            <div class="contact-info-box address clearfix">
              ...
              <p>Accusantium quam, aliquam ultricies eget tempor id, aliquam eget nibh et. Maecen aliquam, risus at semper. Accusantium
                quam, aliquam ultricies eget tempor id, aliquam eget nibh et. Maecen aliquam, risus at semper.</p>
